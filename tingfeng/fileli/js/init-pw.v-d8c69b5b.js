  ...
  [582],
  {
        ...
        (t.getBlockOrElementRender = function (e) {
          ...
          var r =
              ...
              void 0 === n
                ...
                : n.psUuid,
            d =
              null === (i = window.fData.initialData) ||
              void 0 === i ||
              null === (i = i.app) ||
              void 0 === i
                ? void 0
          ...
          return (
            (s[u ? "bu" : "eu"] = l),
            window.axios
              .get("/pw/render", { params: s, retry: 2 })
              .then(function (t) {
                var n,
                  o =
                    null == t ||
        ...
        !!document.querySelector(".js-instagram-images-fetch") &&
          window.axios
            ...
            .then(function (e) {
              var t = e.userMedia,
                n = e.userProfile,
                a = new CustomEvent("userMediaFetched", { detail: t });
    ...
    52713: (e, t, n) => {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        document.body.classList.contains("photo--protected") &&
            ...
            var r = 20,
              d = setInterval(function () {
                if (((r -= 1), window.PW)) clearInterval(d), i();
                  ...
                  if ((clearInterval(d), !n || window.localStorage.getItem(t)))
                    throw new Error(
                      n
                        ? "PW seems to be undefined after reload."
                        : "PW seems to be undefined and localStorage is not available."
                    );
